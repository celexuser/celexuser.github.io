...
if (!checkCookie(key)) { // if the key does not exist in the cookie
  alert("Hello! Hey welcome to MNv2 this update took me and the devs way too long to create to feel free to support us by joining our discord! <3"); // display an alert message
